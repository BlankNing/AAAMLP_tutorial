...
from OptAUC import OptimizeAUC
import numpy as np
...
print(f"Fold-2: LR AUC = {aucs_fold2[0]:.3f}")
print(f"Fold-2: RF AUC = {aucs_fold2[1]:.3f}")
print(f"Fold-2: XGB AUC = {aucs_fold2[2]:.3f}")
print(f"Fold-2: Average Pred AUC = {aucs_fold2[3]:.3f}")
...
print(f"Fold-1: LR AUC = {aucs_fold1[0]:.3f}")
print(f"Fold-1: RF AUC = {aucs_fold1[1]:.3f}")
print(f"Fold-1: XGB AUC = {aucs_fold1[2]:.3f}")
print(f"Fold-1: Average prediction AUC = {aucs_fold1[3]:.3f}")
...
print(f"Optimized AUC, Fold 2 = {auc:.3f}")
...
print(f"Optimized AUC, Fold 1 = {auc:.3f}")
print(f"Coefficients = {opt.coef_}")
