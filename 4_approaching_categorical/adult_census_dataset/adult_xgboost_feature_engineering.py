# This time, by adding a little bit of naive feature engineering, we are
# able to achieve better results than the previous model.
...
def run(fold):
    ...
    # ensure the income column is of integer type
